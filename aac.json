...
let userID = 'ab40dd92-2b90-4897-807f-1088ca7a63e4';
			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				switch (url.pathname) {
					...
					default:
						...
						const hostnames = ['www.fmprc.gov.cn', 'www.xuexi.cn', 'www.gov.cn',mail.gov.com, 'www.mofcom.gov.cn', 'www.gfbzb.gov.cn', 'www.miit.gov.cn', 'www.12377.cn'];
